...
router.get('/my_groups?user_id=:userId', (req, res) => {
...
router.get("/callback", async (req, res) => {
    ...
    try {
        ...
        sw.getCurrentUser().then( (swRes) => {
            s_id = swRes.id;
            s_email = swRes.email;
            let sql = `INSERT INTO Users VALUES (?, ?, "${s_email}", ${s_id});`;
...
router.post('/add_group_expense?group_id=:group_id&cost=:cost&description=:description', (req, res) => {
    group_id = req.params.group_id;
